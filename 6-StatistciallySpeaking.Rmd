...
weather_vars <- f_w_by_month |>
  select(temp, wind_speed, precip, visib, dep_delay)
#filter out extreme
...
model_data <- flights_weather |>
  select(arr_delay, precip, temp, humid, visib, carrier, origin, month, hour) |>
