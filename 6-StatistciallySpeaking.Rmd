...
member_contributions <- data.frame(
  Member = c("Shreya", "Kalyani", "Karen", "Crystal", "Mason"),
  Contribution = c(
    "Planes Dataset EDA & Analysis Question #4",
    "Weather Dataset EDA & Analysis Question #2",
    "Flights Dataset EDA & Analysis Question #3",
    "Airports Dataset EDA & Analysis Question #5",
    "Analysis Question #1"
  )
)

kable(member_contributions, caption = "Team Member Contributions")
```
