...
To prepare for further analysis and cross-validation, the merged dataset, denoted as 'flights_weather', was grouped by airport origin.
...
A sample of 1,000 observations was randomly selected from each airport group using the 'sample_n' function.
...
For the Residuals vs Leverage Plots, we can see a presence of influential observations, which can affect the model's coefficients and overall fit. All trends were similarly observered across all three models. 
